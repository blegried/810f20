---
title: "STATS 810 Fall 2020, Homework 9. <br>Internet repositories for collaboration and open-source research: git and GitHub"
output:
  html_document:
    theme: flatly
    toc: no
...
* Our tasks are 
    ...
    iv. Report briefly on your past experience with git, and what you learned while studying for this homework. Edit the `hw09.Rmd` file in the `810f20` git repository, compile this to html (for example, using Rstudio) and submit your report via Canvas as an html file.

I HAVE NO EXPERIENCE USING GIT.  I have just been clicking around and typing commands; not sure yet what I have done.
...
* If you tell me your GitHub username, I could in principle add you as a developer of the `ionides/810f20` GitHub repository. Then you can commit changes directly.
...
4. Move to the `810f20` directory and edit the file `sign_here.html` to add your own name.
...
5. Commit this change to your local version of the forked `810f20`,
...
6. Push this change to your forked copy of `810f20` on GitHub:

```
git push
```

7. On the GitHub web site for the `my_username/810f20` fork, click `New pull request` and follow instructions. When you have successfully placed your pull request, the owner of the parent repository (me) will be notifed. I will then pull the modifications from your fork into `ionides/810f20`.
